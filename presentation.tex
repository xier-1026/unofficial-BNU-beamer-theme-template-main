...
\author[Xi'er]{Xi'er-1026}
\institute{School of Physics and Astronomy,Beijing Normal University}
\date{\today}
...
\vspace{1cm}
{\large Xi'er}\\
{\small School of Physics and Astronomy,Beijing Normal University}\\
{\small \today}
\end{column}
\begin{column}{0.5\textwidth}
\centering
